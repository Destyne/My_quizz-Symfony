...
class appDevDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            '1_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f' => 'get106f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5fService',
            '2_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f' => 'get206f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5fService',
        ...
        $this->privates = array(
            '1_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f' => true,
            '2_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f' => true,
    ...
    protected function getConfigCacheFactoryService()
    {
        return $this->services['config_cache_factory'] = new \Symfony\Component\Config\ResourceCheckerConfigCacheFactory(new RewindableGenerator(function () {
            yield 0 => ${($_ = isset($this->services['1_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f']) ? $this->services['1_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f'] : $this->get106f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5fService()) && false ?: '_'};
            yield 1 => ${($_ = isset($this->services['2_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f']) ? $this->services['2_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f'] : $this->get206f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5fService()) && false ?: '_'};
        }, 2));
    }
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = ${($_ = isset($this->services['doctrine.dbal.connection_factory']) ? $this->services['doctrine.dbal.connection_factory'] : $this->get('doctrine.dbal.connection_factory')) && false ?: '_'}->createConnection(array('driver' => 'pdo_mysql', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'my_quizz', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf_orm_default_478a28521539f551c3d1ea203953696081fa979a4dc80e21c284008f4224d98c');
    ...
    {
        return $this->services['fos_user.mailer'] = new \FOS\UserBundle\Mailer\TwigSwiftMailer(${($_ = isset($this->services['swiftmailer.mailer.default']) ? $this->services['swiftmailer.mailer.default'] : $this->get('swiftmailer.mailer.default')) && false ?: '_'}, ${($_ = isset($this->services['router']) ? $this->services['router'] : $this->get('router')) && false ?: '_'}, ${($_ = isset($this->services['twig']) ? $this->services['twig'] : $this->get('twig')) && false ?: '_'}, array('template' => array('confirmation' => '@FOSUser/Registration/email.txt.twig', 'resetting' => 'email/password_resetting.email.twig'), 'from_email' => array('confirmation' => array('resetting@example.com' => 'Demo Resetting'), 'resetting' => array('resetting@example.com' => 'Demo Resetting'))));
    }
    ...
    protected function getSwiftmailer_Mailer_Default_Transport_RealService()
    {
        ...
        $a->setUsername('mdrpol@yopmail.com');
        $a->setPassword(NULL);
        $a->setAuthMode(NULL);
        ...
        $instance->setHost('smtp.yopmail.com');
        $instance->setPort(25);
    ...
    protected function getTwig_LoaderService()
    {
        ...
        $instance->addPath(($this->targetDirs[3].'/src/WAC/QuizzBundle/Resources/views'), 'WACQuizz');
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('68204d34436089c5ee5e1549121619a65b2a9221');
    }
    ...
    /**
     * Gets the private '1_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker
     */
    protected function get106f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5fService()
    {
        return $this->services['1_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f'] = new \Symfony\Component\DependencyInjection\Config\ContainerParametersResourceChecker($this);
    }

    /**
     * Gets the private '2_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f' shared service.
     *
     * @return \Symfony\Component\Config\Resource\SelfCheckingResourceChecker
     */
    protected function get206f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5fService()
    {
        return $this->services['2_06f1a313e5a72af70f77e2acea4aa7aff42b782dae3d04397a12da6005207a5f'] = new \Symfony\Component\Config\Resource\SelfCheckingResourceChecker();
    }
    ...
    {
        $this->services['cache.app.recorder_inner'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('esufHFLDfU', 0, (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.serializer.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('sUUIsL50lR', 0, '0MqjPEjaMOyvHRdATpMYPx', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.system.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('qz9-ZLuVHN', 0, '0MqjPEjaMOyvHRdATpMYPx', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['cache.validator.recorder_inner'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('B46aWMZhkB', 0, '0MqjPEjaMOyvHRdATpMYPx', (__DIR__.'/pools'), ${($_ = isset($this->services['monolog.logger.cache']) ? $this->services['monolog.logger.cache'] : $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE)) && false ?: '_'});
    }
    ...
    {
        return $this->services['security.authentication.provider.anonymous.main'] = new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('5a201cb640fff2.35182435');
    }
    ...
    private function getDynamicParameter($name)
    {
        switch ($name) {
            ...
            case 'kernel.bundles_metadata': $value = array(
                ...
                'WACQuizzBundle' => array(
                    'parent' => NULL,
                    'path' => ($this->targetDirs[3].'/src/WAC/QuizzBundle'),
                    'namespace' => 'WAC\\QuizzBundle',
                ),
                'DebugBundle' => array(
                    'parent' => NULL,
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'WACQuizzBundle' => 'WAC\\QuizzBundle\\WACQuizzBundle',
            ...
            'database_port' => NULL,
            'database_name' => 'my_quizz',
            'database_user' => 'root',
            'database_password' => NULL,
            'mailer_transport' => 'smtp',
            'mailer_host' => 'smtp.yopmail.com',
            'mailer_user' => 'mdrpol@yopmail.com',
            'mailer_encryption' => 'tls',
            'secret' => '68204d34436089c5ee5e1549121619a65b2a9221',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '68204d34436089c5ee5e1549121619a65b2a9221',
            ...
            'swiftmailer.mailer.default.transport.smtp.host' => 'smtp.yopmail.com',
            'swiftmailer.mailer.default.transport.smtp.username' => 'mdrpol@yopmail.com',
